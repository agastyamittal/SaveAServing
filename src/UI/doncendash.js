...
function doncendash(){
    return (
        ...
        <Button component={Link} to="/bsignup" style={{color : "white", borderRadius: 5, backgroundColor: "#024abf"}} variant="contained">Add Your Donation Center</Button>
        </Box>
        ...
        <Box marginTop = "75px" alignItems = "center" justifyContent = "center" display = "flex">
        <Typography align = "center" variant = "h5" sx={{fontWeight: "600"}} marginTop = "50px">Donation Center Dashboard</Typography>
        </Box>
        </>
    );
}
